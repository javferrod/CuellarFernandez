...
\begin{figure}[H]
  \centering
   \includegraphics[width=0.55\textwidth]{Images/StatechartBusquedaGrupal}
...
\begin{figure}[H]
  \centering
   \includegraphics[width=0.55\textwidth]{Images/StatechartIndividualSearch}
...
\begin{figure}[H]
  \centering
   \includegraphics[width=0.80\textwidth]{Images/TrackSequenceDiagram}
...
\begin{figure}[H]
  \centering
   \includegraphics[width=0.85\textwidth]{Images/ClassDiagram}
...
\begin{table}[H]
  ...
  \begin{tabular}{cp{16cm}}
    ...
    \midrule
    \perflabel{perf:req-per-second} & \begin{tabular}{@{}p{16cm}@{}}
    The system shall be able to process at least 500 request per second.
    \end{tabular} \\
    \hline
    \perflabel{perf:response-time} & \begin{tabular}{@{}p{16cm}@{}}
