...
var _temporal = require('../database/temporal');
...
dataRecollector.post('/', function (ctx, next) {
    return new Promise(function ($return, $error) {
        ...
        return processParameters(parameters).then(function ($await_1) {
...
function processParameters(parameters, user) {
    return new Promise(function ($return, $error) {
        parameters.filter(_validators.isValidParameter).forEach((0, _temporal.saveTemporalParameter)(user));
        return $return();
    });
}
