...
exports.default = function connectToDatabase() {
    return new Promise(function ($return, $error) {
        console.log("[i] Connecting to POSTGRE");
        ...
        var $Try_1_Post = function () {
            ...
            return testConnection().then(function ($await_2) {
                return $Try_1_Post();
...
function createDatabase() {
    return new Promise(function ($return, $error) {
        ...
        return temporal.raw('CREATE DATABASE data').then(function ($await_3) {
            temporal.destroy();
            return $return();
