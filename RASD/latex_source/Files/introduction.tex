...
\begin{itemize}
    ...
    \item \textbf{Plan ID:} \comment {Añadir definición}
    
    \item \textbf{Subscription ID:} \comment{Añadir definición}
    
    \item \textbf{Track:} \comment{Aádir definición}
    
    \item \textbf{Token:} \comment{Añadir definición}
...
\begin{itemize}
    ...
    You can start by reading this section on page \pageref{sect:introduction}.
    ...
    You can start by reading this section on page \pageref{sect:overview}.
    ...
    You can start by reading this section on page \pageref{sect:requirements}.
