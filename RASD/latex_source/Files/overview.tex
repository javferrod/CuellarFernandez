...
\begin{itemize}
    \item \textbf{Insurance:} \comment{Pendiente}
    \item \textbf{Marketing:} \comment{Pendiente}
    \item \textbf{Banks:} \comment{Pendiente}
    \item \textbf{Wellness and health applications:} \comment{Pendiente}
    \item \textbf{} \comment{Añadir alguno más}
\end{itemize}
...
\begin{itemize}
    ...
    \item The devices (mobile phone and smartwatch) work correctly.
\end{itemize}
\comment{Ver si se nos ocurre alguna más}
...
\comment{Añadir enlace o referencia a la documentación oficial de Stripe}
